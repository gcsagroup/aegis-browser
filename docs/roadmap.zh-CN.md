...
Browser Agent v2 候选源码包含 95 个顶层 Chromium 补丁和 2 个嵌套 V8 补丁，可精确重放到 Chromium 提交 `c930fa41ef7e9522f145848f3080ee0cc1edc4d8`；57、65 和 67 补丁记录只保留为历史快照。平台产物身份和受影响运行验收仍是独立的开放门禁。
