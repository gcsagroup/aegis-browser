...
4. 受影響門禁必須在同一已提交原始碼和帶身分清單的成品上重跑。Browser Agent v2 候選原始碼包含 105 個頂層 Chromium 補丁和 2 個巢狀 V8 補丁，可重放到 `1e1341b51e3254d4638bc1917b140f30d4c1e9d7`（tree `babd10e2e757d7b57f1b7ef18eac26ee5becc9cb`）；57、65、67、95 和 97 補丁記錄只保留為歷史證據。
