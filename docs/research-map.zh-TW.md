...
4. 受影響門禁必須在同一已提交原始碼和帶身分清單的成品上重跑。Browser Agent v2 候選原始碼包含 95 個頂層 Chromium 補丁和 2 個巢狀 V8 補丁，可重放到 `c930fa41ef7e9522f145848f3080ee0cc1edc4d8`；57、65 和 67 補丁記錄只保留為歷史證據。
