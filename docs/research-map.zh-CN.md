...
4. 受影响门禁必须在同一已提交源码和带身份清单的产物上重跑。Browser Agent v2 候选源码包含 95 个顶层 Chromium 补丁和 2 个嵌套 V8 补丁，可重放到 `c930fa41ef7e9522f145848f3080ee0cc1edc4d8`；57、65 和 67 补丁记录只保留为历史证据。
