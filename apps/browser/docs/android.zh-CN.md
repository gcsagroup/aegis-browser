...
- v2 候选源码包含 95 个顶层 Chromium 补丁和 2 个嵌套 V8 补丁，可精确重放到 `c930fa41ef7e9522f145848f3080ee0cc1edc4d8`。当前 Android 构建和真机验收仍在进行；历史 macOS 证据不能赋予 Android 产物资格。
...
1. 在干净 x86-64 Linux checkout 中，从固定基线重放全部 95 个 Chromium 补丁和 2 个嵌套 V8 补丁。
