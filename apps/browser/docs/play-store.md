...
2. Bind the repository commit, Chromium commit, 95 Chromium patches, 2 nested V8 patches, GN arguments, package identity, and artifact hashes in a verified Android manifest.
