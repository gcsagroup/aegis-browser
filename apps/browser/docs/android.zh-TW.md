...
- v2 候選原始碼包含 105 個頂層 Chromium 補丁和 2 個巢狀 V8 補丁，可精確重放到 `1e1341b51e3254d4638bc1917b140f30d4c1e9d7`（tree `babd10e2e757d7b57f1b7ef18eac26ee5becc9cb`）。目前 Android 建置和實機驗收仍在進行；歷史 macOS 證據不能賦予 Android 成品資格。
...
1. 在乾淨 x86-64 Linux checkout 中，從固定基線重放全部 105 個 Chromium 補丁和 2 個巢狀 V8 補丁。
