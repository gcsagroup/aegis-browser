...
| --- | --- |
| [Roadmap](docs/roadmap.md) · [Documentation index](docs/README.md) · [Architecture](docs/architecture.md)<br>[Browser engineering guide](apps/browser/README.md) · [iOS engineering guide](apps/ios/README.md)<br>[Research and limitations](docs/research-map.md) · [Historical audit records](docs/audit/README.md)<br>[Changelog](CHANGELOG.md) | GCSA-authored source uses [Apache-2.0](LICENSE).<br>Chromium, libtorrent and other third-party components retain their own licenses.<br>[Third-party acknowledgements](THIRD_PARTY_NOTICES.md) |
